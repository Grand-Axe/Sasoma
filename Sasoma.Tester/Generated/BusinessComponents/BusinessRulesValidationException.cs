...
{
	/// <summary>
	/// Exception class for an business rules validattion exception in the Business Layer.
	/// </summary>
	[Serializable]
	public class BusinessRulesValidationException : Exception
    {
		...
		/// </summary>
		public BusinessRulesValidationException()
		{
		}
		...
		public BusinessRulesValidationException(string message) : base(message) 
		{
		...
		public BusinessRulesValidationException(string message, Exception exception) : base(message, exception) 
		{
        ...
        /// If the innerException parameter is not a null reference, the current exception 
        /// is raised in a catch block that handles the inner exception.</param>
        public BusinessRulesValidationException(string message, int errorNumber, Exception exception)
		...
		protected BusinessRulesValidationException(SerializationInfo info, StreamingContext context) : base(info, context) 
		{
