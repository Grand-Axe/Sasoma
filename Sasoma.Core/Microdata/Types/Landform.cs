...
namespace Sasoma.Microdata.Types
{
	...
	/// </summary>
	public class Landform_Core : TypeCore, IPlace
	{
		public Landform_Core()
		{
			this._TypeId = 146;
			this._Id = "Landform";
			this._Schema_Org_Url = "http://schema.org/Landform";
			string label = "";
			GetLabel(out label, "Landform", typeof(Landform_Core));
			this._Label = label;
			this._Ancestors = new int[]{266,206};
			this._SubTypes = new int[]{40,71,168,287};
