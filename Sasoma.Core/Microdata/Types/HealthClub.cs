...
namespace Sasoma.Microdata.Types
{
	...
	/// A health club.
	/// </summary>
	public class HealthClub_Core : TypeCore, IHealthAndBeautyBusiness
	{
		public HealthClub_Core()
		{
			this._TypeId = 124;
			this._Id = "HealthClub";
			this._Schema_Org_Url = "http://schema.org/HealthClub";
			string label = "";
			GetLabel(out label, "HealthClub", typeof(HealthClub_Core));
			this._Label = label;
			this._Ancestors = new int[]{266,193,155,123};
			this._SubTypes = new int[0];
			this._SuperTypes = new int[]{246,123};
