...
namespace Sasoma.Microdata.Types
{
	...
	/// A city hall.
	/// </summary>
	public class CityHall_Core : TypeCore, IGovernmentBuilding
	{
		public CityHall_Core()
		{
			this._TypeId = 61;
			this._Id = "CityHall";
			this._Schema_Org_Url = "http://schema.org/CityHall";
			string label = "";
			GetLabel(out label, "CityHall", typeof(CityHall_Core));
			this._Label = label;
