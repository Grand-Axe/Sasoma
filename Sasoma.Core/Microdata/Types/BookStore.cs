...
namespace Sasoma.Microdata.Types
{
	...
	/// A bookstore.
	/// </summary>
	public class BookStore_Core : TypeCore, IStore
	{
		public BookStore_Core()
		{
			this._TypeId = 43;
			this._Id = "BookStore";
			this._Schema_Org_Url = "http://schema.org/BookStore";
			string label = "";
			GetLabel(out label, "BookStore", typeof(BookStore_Core));
			this._Label = label;
