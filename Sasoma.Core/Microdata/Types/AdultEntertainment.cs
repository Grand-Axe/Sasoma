...
namespace Sasoma.Microdata.Types
{
	...
	/// </summary>
	public class AdultEntertainment_Core : TypeCore, IEntertainmentBusiness
	{
		public AdultEntertainment_Core()
		{
			this._TypeId = 11;
			this._Id = "AdultEntertainment";
			this._Schema_Org_Url = "http://schema.org/AdultEntertainment";
			string label = "";
			GetLabel(out label, "AdultEntertainment", typeof(AdultEntertainment_Core));
			this._Label = label;
