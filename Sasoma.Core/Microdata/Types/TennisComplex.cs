...
namespace Sasoma.Microdata.Types
{
	...
	/// A tennis complex.
	/// </summary>
	public class TennisComplex_Core : TypeCore, ISportsActivityLocation
	{
		public TennisComplex_Core()
		{
			this._TypeId = 263;
			this._Id = "TennisComplex";
			this._Schema_Org_Url = "http://schema.org/TennisComplex";
			string label = "";
			GetLabel(out label, "TennisComplex", typeof(TennisComplex_Core));
			this._Label = label;
