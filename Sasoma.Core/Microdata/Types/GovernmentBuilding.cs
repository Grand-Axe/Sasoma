...
namespace Sasoma.Microdata.Types
{
	...
	/// </summary>
	public class GovernmentBuilding_Core : TypeCore, ICivicStructure
	{
		public GovernmentBuilding_Core()
		{
			this._TypeId = 116;
			this._Id = "GovernmentBuilding";
			this._Schema_Org_Url = "http://schema.org/GovernmentBuilding";
			string label = "";
			GetLabel(out label, "GovernmentBuilding", typeof(GovernmentBuilding_Core));
			this._Label = label;
			this._Ancestors = new int[]{266,206,62};
			this._SubTypes = new int[]{61,75,83,92,149};
