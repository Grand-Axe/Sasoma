...
namespace Sasoma.Microdata.Types
{
	...
	/// </summary>
	public class Place_Core : TypeCore, IThing
	{
		public Place_Core()
		{
			this._TypeId = 206;
			this._Id = "Place";
			this._Schema_Org_Url = "http://schema.org/Place";
			string label = "";
			GetLabel(out label, "Place", typeof(Place_Core));
			this._Label = label;
			this._Ancestors = new int[]{266};
			this._SubTypes = new int[]{10,62,146,147,155,227,268};
