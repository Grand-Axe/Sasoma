...
namespace Sasoma.Microdata.Types
{
	...
	/// A courthouse.
	/// </summary>
	public class Courthouse_Core : TypeCore, IGovernmentBuilding
	{
		public Courthouse_Core()
		{
			this._TypeId = 75;
			this._Id = "Courthouse";
			this._Schema_Org_Url = "http://schema.org/Courthouse";
			string label = "";
			GetLabel(out label, "Courthouse", typeof(Courthouse_Core));
			this._Label = label;
