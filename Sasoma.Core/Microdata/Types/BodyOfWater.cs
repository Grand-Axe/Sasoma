...
namespace Sasoma.Microdata.Types
{
	...
	/// </summary>
	public class BodyOfWater_Core : TypeCore, ILandform
	{
		public BodyOfWater_Core()
		{
			this._TypeId = 40;
			this._Id = "BodyOfWater";
			this._Schema_Org_Url = "http://schema.org/BodyOfWater";
			string label = "";
			GetLabel(out label, "BodyOfWater", typeof(BodyOfWater_Core));
			this._Label = label;
			this._Ancestors = new int[]{266,206,146};
			this._SubTypes = new int[]{52,145,188,211,226,230,236,292};
			this._SuperTypes = new int[]{146};
