...
namespace Sasoma.Microdata.Types
{
	...
	/// </summary>
	public class OceanBodyOfWater_Core : TypeCore, IBodyOfWater
	{
		public OceanBodyOfWater_Core()
		{
			this._TypeId = 188;
			this._Id = "OceanBodyOfWater";
			this._Schema_Org_Url = "http://schema.org/OceanBodyOfWater";
			string label = "";
			GetLabel(out label, "OceanBodyOfWater", typeof(OceanBodyOfWater_Core));
			this._Label = label;
