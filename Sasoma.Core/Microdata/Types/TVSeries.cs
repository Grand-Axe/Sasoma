...
namespace Sasoma.Microdata.Types
{
	...
	/// A television series.
	/// </summary>
	public class TVSeries_Core : TypeCore, ICreativeWork
	{
		public TVSeries_Core()
		{
			this._TypeId = 258;
			this._Id = "TVSeries";
			this._Schema_Org_Url = "http://schema.org/TVSeries";
			string label = "";
			GetLabel(out label, "TVSeries", typeof(TVSeries_Core));
			this._Label = label;
			this._Ancestors = new int[]{266,78};
			this._SubTypes = new int[0];
			this._SuperTypes = new int[]{78};
			this._Properties = new int[]{67,108,143,229,0,2,10,12,18,20,24,26,21,50,51,54,57,58,59,61,62,64,70,72,81,97,100,110,115,116,126,138,151,178,179,180,199,211,219,230,231,3,68,82,84,141,146,174,176,203,214,224};
		...
		/// </summary>
		private Episodes_Core episodes;
		public Episodes_Core Episodes
		{
			get
			{
				return episodes;
		...
		/// </summary>
		private NumberOfEpisodes_Core numberOfEpisodes;
		public NumberOfEpisodes_Core NumberOfEpisodes
		{
			get
			{
			...
			set
			{
				...
				SetPropertyInstance(numberOfEpisodes);
			}
		}
		...
		/// </summary>
		private Seasons_Core seasons;
		public Seasons_Core Seasons
		{
			get
			{
				return seasons;
