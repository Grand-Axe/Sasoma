...
namespace Sasoma.Microdata.Types
{
	...
	/// </summary>
	public class PublicSwimmingPool_Core : TypeCore, ISportsActivityLocation
	{
		public PublicSwimmingPool_Core()
		{
			this._TypeId = 218;
			this._Id = "PublicSwimmingPool";
			this._Schema_Org_Url = "http://schema.org/PublicSwimmingPool";
			string label = "";
			GetLabel(out label, "PublicSwimmingPool", typeof(PublicSwimmingPool_Core));
			this._Label = label;
