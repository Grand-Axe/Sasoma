...
namespace Sasoma.Microdata.Types
{
	...
	/// A preschool.
	/// </summary>
	public class Preschool_Core : TypeCore, IEducationalOrganization
	{
		public Preschool_Core()
		{
			this._TypeId = 214;
			this._Id = "Preschool";
			this._Schema_Org_Url = "http://schema.org/Preschool";
			string label = "";
			GetLabel(out label, "Preschool", typeof(Preschool_Core));
			this._Label = label;
