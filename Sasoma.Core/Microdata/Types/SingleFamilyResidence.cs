...
namespace Sasoma.Microdata.Types
{
	...
	/// </summary>
	public class SingleFamilyResidence_Core : TypeCore, IResidence
	{
		public SingleFamilyResidence_Core()
		{
			this._TypeId = 241;
			this._Id = "SingleFamilyResidence";
			this._Schema_Org_Url = "http://schema.org/SingleFamilyResidence";
			string label = "";
			GetLabel(out label, "SingleFamilyResidence", typeof(SingleFamilyResidence_Core));
			this._Label = label;
