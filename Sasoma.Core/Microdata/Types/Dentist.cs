...
namespace Sasoma.Microdata.Types
{
	...
	/// A dentist.
	/// </summary>
	public class Dentist_Core : TypeCore, IMedicalOrganization
	{
		public int TypeId
		{
			get
		...
		public string Schema_Org_Url
		{
			get
			{
				return "http://schema.org/Dentist";
			}
		}
		...
		public string Label
		{
			get
			{
				GetLabel(out label, "Dentist", typeof(Dentist_Core));
				return label;
			}
		}
