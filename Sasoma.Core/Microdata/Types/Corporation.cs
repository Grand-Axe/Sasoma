...
namespace Sasoma.Microdata.Types
{
	...
	/// </summary>
	public class Corporation_Core : TypeCore, IOrganization
	{
		public Corporation_Core()
		{
			this._TypeId = 73;
			this._Id = "Corporation";
			this._Schema_Org_Url = "http://schema.org/Corporation";
			string label = "";
			GetLabel(out label, "Corporation", typeof(Corporation_Core));
			this._Label = label;
			this._Ancestors = new int[]{266,193};
			this._SubTypes = new int[0];
			this._SuperTypes = new int[]{193};
			this._Properties = new int[]{67,108,143,229,5,10,47,75,77,85,91,94,95,115,130,137,199,196,220};
		...
		/// </summary>
		private TickerSymbol_Core tickerSymbol;
		public TickerSymbol_Core TickerSymbol
		{
			get
			{
				return tickerSymbol;
			...
			{
				tickerSymbol = value;
				SetPropertyInstance(tickerSymbol);
			}
		}
