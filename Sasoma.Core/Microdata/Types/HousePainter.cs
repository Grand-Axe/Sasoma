...
namespace Sasoma.Microdata.Types
{
	...
	/// </summary>
	public class HousePainter_Core : TypeCore, IHomeAndConstructionBusiness
	{
		public HousePainter_Core()
		{
			this._TypeId = 133;
			this._Id = "HousePainter";
			this._Schema_Org_Url = "http://schema.org/HousePainter";
			string label = "";
			GetLabel(out label, "HousePainter", typeof(HousePainter_Core));
			this._Label = label;
