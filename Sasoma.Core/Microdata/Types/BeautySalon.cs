...
namespace Sasoma.Microdata.Types
{
	...
	/// Beauty salon.
	/// </summary>
	public class BeautySalon_Core : TypeCore, IHealthAndBeautyBusiness
	{
		public BeautySalon_Core()
		{
			this._TypeId = 35;
			this._Id = "BeautySalon";
			this._Schema_Org_Url = "http://schema.org/BeautySalon";
			string label = "";
			GetLabel(out label, "BeautySalon", typeof(BeautySalon_Core));
			this._Label = label;
