...
namespace Sasoma.Microdata.Types
{
	...
	/// A graveyard.
	/// </summary>
	public class Cemetery_Core : TypeCore, ICivicStructure
	{
		public Cemetery_Core()
		{
			this._TypeId = 55;
			this._Id = "Cemetery";
			this._Schema_Org_Url = "http://schema.org/Cemetery";
			string label = "";
			GetLabel(out label, "Cemetery", typeof(Cemetery_Core));
			this._Label = label;
