...
namespace Sasoma.Microdata.Types
{
	...
	/// A Buddhist temple.
	/// </summary>
	public class BuddhistTemple_Core : TypeCore, IPlaceOfWorship
	{
		public BuddhistTemple_Core()
		{
			this._TypeId = 46;
			this._Id = "BuddhistTemple";
			this._Schema_Org_Url = "http://schema.org/BuddhistTemple";
			string label = "";
			GetLabel(out label, "BuddhistTemple", typeof(BuddhistTemple_Core));
			this._Label = label;
