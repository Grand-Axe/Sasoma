...
namespace Sasoma.Microdata.Types
{
	...
	/// </summary>
	public class SearchResultsPage_Core : TypeCore, IWebPage
	{
		public SearchResultsPage_Core()
		{
			this._TypeId = 237;
			this._Id = "SearchResultsPage";
			this._Schema_Org_Url = "http://schema.org/SearchResultsPage";
			string label = "";
			GetLabel(out label, "SearchResultsPage", typeof(SearchResultsPage_Core));
			this._Label = label;
