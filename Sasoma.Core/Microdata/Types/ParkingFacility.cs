...
namespace Sasoma.Microdata.Types
{
	...
	/// </summary>
	public class ParkingFacility_Core : TypeCore, ICivicStructure
	{
		public ParkingFacility_Core()
		{
			this._TypeId = 197;
			this._Id = "ParkingFacility";
			this._Schema_Org_Url = "http://schema.org/ParkingFacility";
			string label = "";
			GetLabel(out label, "ParkingFacility", typeof(ParkingFacility_Core));
			this._Label = label;
