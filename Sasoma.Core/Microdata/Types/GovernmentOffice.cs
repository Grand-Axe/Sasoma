...
namespace Sasoma.Microdata.Types
{
	...
	/// </summary>
	public class GovernmentOffice_Core : TypeCore, ILocalBusiness
	{
		public GovernmentOffice_Core()
		{
			this._TypeId = 117;
			this._Id = "GovernmentOffice";
			this._Schema_Org_Url = "http://schema.org/GovernmentOffice";
			string label = "";
			GetLabel(out label, "GovernmentOffice", typeof(GovernmentOffice_Core));
			this._Label = label;
			this._Ancestors = new int[]{266,193,155};
			this._SubTypes = new int[]{212};
