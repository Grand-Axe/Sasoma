...
namespace Sasoma.Microdata.Types
{
	...
	/// A bus station.
	/// </summary>
	public class BusStation_Core : TypeCore, ICivicStructure
	{
		public BusStation_Core()
		{
			this._TypeId = 47;
			this._Id = "BusStation";
			this._Schema_Org_Url = "http://schema.org/BusStation";
			string label = "";
			GetLabel(out label, "BusStation", typeof(BusStation_Core));
			this._Label = label;
