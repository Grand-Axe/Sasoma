...
namespace Sasoma.Microdata.Types
{
	...
	/// A tattoo parlor.
	/// </summary>
	public class TattooParlor_Core : TypeCore, IHealthAndBeautyBusiness
	{
		public TattooParlor_Core()
		{
			this._TypeId = 260;
			this._Id = "TattooParlor";
			this._Schema_Org_Url = "http://schema.org/TattooParlor";
			string label = "";
			GetLabel(out label, "TattooParlor", typeof(TattooParlor_Core));
			this._Label = label;
