...
namespace Sasoma.Microdata.Types
{
	...
	/// </summary>
	public class MensClothingStore_Core : TypeCore, IStore
	{
		public MensClothingStore_Core()
		{
			this._TypeId = 164;
			this._Id = "MensClothingStore";
			this._Schema_Org_Url = "http://schema.org/MensClothingStore";
			string label = "";
			GetLabel(out label, "MensClothingStore", typeof(MensClothingStore_Core));
			this._Label = label;
