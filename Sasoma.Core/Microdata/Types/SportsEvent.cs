...
namespace Sasoma.Microdata.Types
{
	...
	/// </summary>
	public class SportsEvent_Core : TypeCore, IEvent
	{
		public SportsEvent_Core()
		{
			this._TypeId = 248;
			this._Id = "SportsEvent";
			this._Schema_Org_Url = "http://schema.org/SportsEvent";
			string label = "";
			GetLabel(out label, "SportsEvent", typeof(SportsEvent_Core));
			this._Label = label;
