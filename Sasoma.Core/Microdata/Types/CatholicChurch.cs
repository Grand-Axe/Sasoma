...
namespace Sasoma.Microdata.Types
{
	...
	/// A Catholic church.
	/// </summary>
	public class CatholicChurch_Core : TypeCore, IPlaceOfWorship
	{
		public CatholicChurch_Core()
		{
			this._TypeId = 54;
			this._Id = "CatholicChurch";
			this._Schema_Org_Url = "http://schema.org/CatholicChurch";
			string label = "";
			GetLabel(out label, "CatholicChurch", typeof(CatholicChurch_Core));
			this._Label = label;
