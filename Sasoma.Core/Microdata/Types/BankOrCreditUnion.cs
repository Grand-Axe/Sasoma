...
namespace Sasoma.Microdata.Types
{
	...
	/// </summary>
	public class BankOrCreditUnion_Core : TypeCore, IFinancialService
	{
		public BankOrCreditUnion_Core()
		{
			this._TypeId = 32;
			this._Id = "BankOrCreditUnion";
			this._Schema_Org_Url = "http://schema.org/BankOrCreditUnion";
			string label = "";
			GetLabel(out label, "BankOrCreditUnion", typeof(BankOrCreditUnion_Core));
			this._Label = label;
			this._Ancestors = new int[]{266,193,155,103};
			this._SubTypes = new int[0];
			this._SuperTypes = new int[]{103};
