...
namespace Sasoma.Microdata.Types
{
	...
	public class Recipe_Core : TypeCore, ICreativeWork
	{
		...
		/// </summary>
		public CookingMethod_Core CookingMethod { get; set; }
		...
		/// </summary>
		public CookTime_Core CookTime { get; set; }
		...
		/// </summary>
		public Ingredients_Core Ingredients { get; set; }
		...
		/// </summary>
		public Nutrition_Core Nutrition { get; set; }
		...
		/// </summary>
		public PrepTime_Core PrepTime { get; set; }
		...
		/// </summary>
		public RecipeCategory_Core RecipeCategory { get; set; }

		/// <summary>
		/// The cuisine of the recipe (for example, French or Ethopian).
		/// </summary>
		public RecipeCuisine_Core RecipeCuisine { get; set; }

		/// <summary>
		/// The steps to make the dish.
		/// </summary>
		public RecipeInstructions_Core RecipeInstructions { get; set; }

		/// <summary>
		/// The quantity produced by the recipe (for example, number of people served, number of servings, etc).
		/// </summary>
		public RecipeYield_Core RecipeYield { get; set; }
		...
		/// </summary>
		public TotalTime_Core TotalTime { get; set; }
