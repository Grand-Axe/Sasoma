...
namespace Sasoma.Microdata.Types
{
	...
	/// A recipe.
	/// </summary>
	public class Recipe_Core : TypeCore, ICreativeWork
	{
		public Recipe_Core()
		{
			this._TypeId = 224;
			this._Id = "Recipe";
			this._Schema_Org_Url = "http://schema.org/Recipe";
			string label = "";
			GetLabel(out label, "Recipe", typeof(Recipe_Core));
			this._Label = label;
			this._Ancestors = new int[]{266,78};
			this._SubTypes = new int[0];
			this._SuperTypes = new int[]{78};
			this._Properties = new int[]{67,108,143,229,0,2,10,12,18,20,24,26,21,50,51,54,57,58,59,61,62,64,70,72,81,97,100,110,115,116,126,138,151,178,179,180,199,211,219,230,231,55,56,114,148,164,184,185,186,187,222};
		...
		/// </summary>
		private CookingMethod_Core cookingMethod;
		public CookingMethod_Core CookingMethod
		{
			get
			{
			...
			{
				cookingMethod = value;
				SetPropertyInstance(cookingMethod);
			}
		}
		...
		/// </summary>
		private CookTime_Core cookTime;
		public CookTime_Core CookTime
		{
			get
			{
				return cookTime;
		...
		/// </summary>
		private Ingredients_Core ingredients;
		public Ingredients_Core Ingredients
		{
			get
			{
				return ingredients;
			...
			{
				ingredients = value;
				SetPropertyInstance(ingredients);
			}
		}
		...
		/// </summary>
		private Nutrition_Core nutrition;
		public Nutrition_Core Nutrition
		{
			get
			{
				return nutrition;
		...
		/// </summary>
		private PrepTime_Core prepTime;
		public PrepTime_Core PrepTime
		{
			get
			{
				return prepTime;
		...
		/// </summary>
		private RecipeCategory_Core recipeCategory;
		public RecipeCategory_Core RecipeCategory
		{
			get
			{
			...
			set
			{
				...
				SetPropertyInstance(recipeCategory);
			}
		}
		...
		/// </summary>
		private RecipeCuisine_Core recipeCuisine;
		public RecipeCuisine_Core RecipeCuisine
		{
			get
			{
			...
			{
				recipeCuisine = value;
				SetPropertyInstance(recipeCuisine);
			}
		}
		...
		/// </summary>
		private RecipeInstructions_Core recipeInstructions;
		public RecipeInstructions_Core RecipeInstructions
		{
			get
			{
			...
			set
			{
				...
				SetPropertyInstance(recipeInstructions);
			}
		}
		...
		/// </summary>
		private RecipeYield_Core recipeYield;
		public RecipeYield_Core RecipeYield
		{
			get
			{
				return recipeYield;
			...
			{
				recipeYield = value;
				SetPropertyInstance(recipeYield);
			}
		}
		...
		/// </summary>
		private TotalTime_Core totalTime;
		public TotalTime_Core TotalTime
		{
			get
			{
				return totalTime;
