...
namespace Sasoma.Microdata.Types
{
	...
	/// A real-estate agent.
	/// </summary>
	public class RealEstateAgent_Core : TypeCore, ILocalBusiness
	{
		public RealEstateAgent_Core()
		{
			this._TypeId = 223;
			this._Id = "RealEstateAgent";
			this._Schema_Org_Url = "http://schema.org/RealEstateAgent";
			string label = "";
			GetLabel(out label, "RealEstateAgent", typeof(RealEstateAgent_Core));
			this._Label = label;
