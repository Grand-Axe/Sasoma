...
namespace Sasoma.Microdata.Types
{
	...
	/// </summary>
	public class TheaterEvent_Core : TypeCore, IEvent
	{
		public TheaterEvent_Core()
		{
			this._TypeId = 264;
			this._Id = "TheaterEvent";
			this._Schema_Org_Url = "http://schema.org/TheaterEvent";
			string label = "";
			GetLabel(out label, "TheaterEvent", typeof(TheaterEvent_Core));
			this._Label = label;
