...
namespace Sasoma.Microdata.Types
{
	...
	/// A doctor's office.
	/// </summary>
	public class Physician_Core : TypeCore, IMedicalOrganization
	{
		public Physician_Core()
		{
			this._TypeId = 205;
			this._Id = "Physician";
			this._Schema_Org_Url = "http://schema.org/Physician";
			string label = "";
			GetLabel(out label, "Physician", typeof(Physician_Core));
			this._Label = label;
