...
namespace Sasoma.Microdata.Types
{
	...
	/// </summary>
	public class SportingGoodsStore_Core : TypeCore, IStore
	{
		public SportingGoodsStore_Core()
		{
			this._TypeId = 245;
			this._Id = "SportingGoodsStore";
			this._Schema_Org_Url = "http://schema.org/SportingGoodsStore";
			string label = "";
			GetLabel(out label, "SportingGoodsStore", typeof(SportingGoodsStore_Core));
			this._Label = label;
