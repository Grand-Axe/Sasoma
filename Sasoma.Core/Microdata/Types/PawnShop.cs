...
namespace Sasoma.Microdata.Types
{
	...
	/// A pawnstore.
	/// </summary>
	public class PawnShop_Core : TypeCore, IStore
	{
		public PawnShop_Core()
		{
			this._TypeId = 198;
			this._Id = "PawnShop";
			this._Schema_Org_Url = "http://schema.org/PawnShop";
			string label = "";
			GetLabel(out label, "PawnShop", typeof(PawnShop_Core));
			this._Label = label;
