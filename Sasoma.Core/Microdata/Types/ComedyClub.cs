...
namespace Sasoma.Microdata.Types
{
	...
	/// A comedy club.
	/// </summary>
	public class ComedyClub_Core : TypeCore, IEntertainmentBusiness
	{
		public ComedyClub_Core()
		{
			this._TypeId = 66;
			this._Id = "ComedyClub";
			this._Schema_Org_Url = "http://schema.org/ComedyClub";
			string label = "";
			GetLabel(out label, "ComedyClub", typeof(ComedyClub_Core));
			this._Label = label;
