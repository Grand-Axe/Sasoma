...
namespace Sasoma.Microdata.Types
{
	...
	/// An optician's store.
	/// </summary>
	public class Optician_Core : TypeCore, IMedicalOrganization
	{
		public Optician_Core()
		{
			this._TypeId = 192;
			this._Id = "Optician";
			this._Schema_Org_Url = "http://schema.org/Optician";
			string label = "";
			GetLabel(out label, "Optician", typeof(Optician_Core));
			this._Label = label;
