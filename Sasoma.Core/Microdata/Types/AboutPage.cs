...
namespace Sasoma.Microdata.Types
{
	...
	/// </summary>
	public class AboutPage_Core : TypeCore, IWebPage
	{
		public AboutPage_Core()
		{
			this._TypeId = 8;
			this._Id = "AboutPage";
			this._Schema_Org_Url = "http://schema.org/AboutPage";
			string label = "";
			GetLabel(out label, "AboutPage", typeof(AboutPage_Core));
			this._Label = label;
