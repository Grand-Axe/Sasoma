...
namespace Sasoma.Microdata.Types
{
	...
	/// </summary>
	public class MusicEvent_Core : TypeCore, IEvent
	{
		public MusicEvent_Core()
		{
			this._TypeId = 175;
			this._Id = "MusicEvent";
			this._Schema_Org_Url = "http://schema.org/MusicEvent";
			string label = "";
			GetLabel(out label, "MusicEvent", typeof(MusicEvent_Core));
			this._Label = label;
