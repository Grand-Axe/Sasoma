...
namespace Sasoma.Microdata.Types
{
	...
	/// </summary>
	public class UserPlays_Core : TypeCore, IUserInteraction
	{
		public UserPlays_Core()
		{
			this._TypeId = 280;
			this._Id = "UserPlays";
			this._Schema_Org_Url = "http://schema.org/UserPlays";
			string label = "";
			GetLabel(out label, "UserPlays", typeof(UserPlays_Core));
			this._Label = label;
