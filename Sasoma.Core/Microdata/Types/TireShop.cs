...
namespace Sasoma.Microdata.Types
{
	...
	/// A tire shop.
	/// </summary>
	public class TireShop_Core : TypeCore, IStore
	{
		public TireShop_Core()
		{
			this._TypeId = 267;
			this._Id = "TireShop";
			this._Schema_Org_Url = "http://schema.org/TireShop";
			string label = "";
			GetLabel(out label, "TireShop", typeof(TireShop_Core));
			this._Label = label;
