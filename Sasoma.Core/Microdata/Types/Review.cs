...
namespace Sasoma.Microdata.Types
{
	...
	/// </summary>
	public class Review_Core : TypeCore, ICreativeWork
	{
		public Review_Core()
		{
			this._TypeId = 229;
			this._Id = "Review";
			this._Schema_Org_Url = "http://schema.org/Review";
			string label = "";
			GetLabel(out label, "Review", typeof(Review_Core));
			this._Label = label;
			this._Ancestors = new int[]{266,78};
			this._SubTypes = new int[0];
			this._SuperTypes = new int[]{78};
			this._Properties = new int[]{67,108,143,229,0,2,10,12,18,20,24,26,21,50,51,54,57,58,59,61,62,64,70,72,81,97,100,110,115,116,126,138,151,178,179,180,199,211,219,230,231,123,194,198};
		...
		/// </summary>
		private ReviewBody_Core reviewBody;
		public ReviewBody_Core ReviewBody
		{
			get
			{
				return reviewBody;
			...
			{
				reviewBody = value;
				SetPropertyInstance(reviewBody);
			}
		}
		...
		/// </summary>
		private ReviewRating_Core reviewRating;
		public ReviewRating_Core ReviewRating
		{
			get
			{
				return reviewRating;
			...
			{
				reviewRating = value;
				SetPropertyInstance(reviewRating);
			}
		}
