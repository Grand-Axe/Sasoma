...
namespace Sasoma.Microdata.Types
{
	...
	/// </summary>
	public class AdministrativeArea_Core : TypeCore, IPlace
	{
		public AdministrativeArea_Core()
		{
			this._TypeId = 10;
			this._Id = "AdministrativeArea";
			this._Schema_Org_Url = "http://schema.org/AdministrativeArea";
			string label = "";
			GetLabel(out label, "AdministrativeArea", typeof(AdministrativeArea_Core));
			this._Label = label;
			this._Ancestors = new int[]{266,206};
			this._SubTypes = new int[]{60,74,251};
