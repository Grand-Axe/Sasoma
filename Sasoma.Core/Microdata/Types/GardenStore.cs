...
namespace Sasoma.Microdata.Types
{
	...
	/// A garden store.
	/// </summary>
	public class GardenStore_Core : TypeCore, IStore
	{
		public GardenStore_Core()
		{
			this._TypeId = 109;
			this._Id = "GardenStore";
			this._Schema_Org_Url = "http://schema.org/GardenStore";
			string label = "";
			GetLabel(out label, "GardenStore", typeof(GardenStore_Core));
			this._Label = label;
