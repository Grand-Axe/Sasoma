...
namespace Sasoma.Microdata.Types
{
	...
	/// An internet cafe.
	/// </summary>
	public class InternetCafe_Core : TypeCore, ILocalBusiness
	{
		public InternetCafe_Core()
		{
			this._TypeId = 139;
			this._Id = "InternetCafe";
			this._Schema_Org_Url = "http://schema.org/InternetCafe";
			string label = "";
			GetLabel(out label, "InternetCafe", typeof(InternetCafe_Core));
			this._Label = label;
