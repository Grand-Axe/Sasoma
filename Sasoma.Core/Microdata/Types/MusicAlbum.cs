...
namespace Sasoma.Microdata.Types
{
	...
	/// </summary>
	public class MusicAlbum_Core : TypeCore, IMusicPlaylist
	{
		public MusicAlbum_Core()
		{
			this._TypeId = 174;
			this._Id = "MusicAlbum";
			this._Schema_Org_Url = "http://schema.org/MusicAlbum";
			string label = "";
			GetLabel(out label, "MusicAlbum", typeof(MusicAlbum_Core));
			this._Label = label;
			this._Ancestors = new int[]{266,78,177};
			this._SubTypes = new int[0];
			this._SuperTypes = new int[]{177};
			this._Properties = new int[]{67,108,143,229,0,2,10,12,18,20,24,26,21,50,51,54,57,58,59,61,62,64,70,72,81,97,100,110,115,116,126,138,151,178,179,180,199,211,219,230,231,145,223,39};
		...
		/// </summary>
		public ByArtist_Core ByArtist { get; set; }
		...
		/// </summary>
		public NumTracks_Core NumTracks { get; set; }
