...
namespace Sasoma.Microdata.Types
{
	...
	/// A police station.
	/// </summary>
	public class PoliceStation_Core : TypeCore, ICivicStructure
	{
		public PoliceStation_Core()
		{
			this._TypeId = 210;
			this._Id = "PoliceStation";
			this._Schema_Org_Url = "http://schema.org/PoliceStation";
			string label = "";
			GetLabel(out label, "PoliceStation", typeof(PoliceStation_Core));
			this._Label = label;
			this._Ancestors = new int[]{266,206,62};
			this._SubTypes = new int[0];
			this._SuperTypes = new int[]{62,93};
