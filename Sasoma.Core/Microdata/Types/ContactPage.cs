...
namespace Sasoma.Microdata.Types
{
	...
	/// </summary>
	public class ContactPage_Core : TypeCore, IWebPage
	{
		public ContactPage_Core()
		{
			this._TypeId = 69;
			this._Id = "ContactPage";
			this._Schema_Org_Url = "http://schema.org/ContactPage";
			string label = "";
			GetLabel(out label, "ContactPage", typeof(ContactPage_Core));
			this._Label = label;
