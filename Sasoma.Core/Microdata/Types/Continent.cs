...
namespace Sasoma.Microdata.Types
{
	...
	/// </summary>
	public class Continent_Core : TypeCore, ILandform
	{
		public Continent_Core()
		{
			this._TypeId = 71;
			this._Id = "Continent";
			this._Schema_Org_Url = "http://schema.org/Continent";
			string label = "";
			GetLabel(out label, "Continent", typeof(Continent_Core));
			this._Label = label;
