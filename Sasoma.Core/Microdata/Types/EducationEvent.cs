...
namespace Sasoma.Microdata.Types
{
	...
	/// </summary>
	public class EducationEvent_Core : TypeCore, IEvent
	{
		public EducationEvent_Core()
		{
			this._TypeId = 87;
			this._Id = "EducationEvent";
			this._Schema_Org_Url = "http://schema.org/EducationEvent";
			string label = "";
			GetLabel(out label, "EducationEvent", typeof(EducationEvent_Core));
			this._Label = label;
