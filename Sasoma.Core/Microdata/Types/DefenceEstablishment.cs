...
namespace Sasoma.Microdata.Types
{
	...
	/// </summary>
	public class DefenceEstablishment_Core : TypeCore, IGovernmentBuilding
	{
		public DefenceEstablishment_Core()
		{
			this._TypeId = 83;
			this._Id = "DefenceEstablishment";
			this._Schema_Org_Url = "http://schema.org/DefenceEstablishment";
			string label = "";
			GetLabel(out label, "DefenceEstablishment", typeof(DefenceEstablishment_Core));
			this._Label = label;
