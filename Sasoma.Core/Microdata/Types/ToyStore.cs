...
namespace Sasoma.Microdata.Types
{
	...
	/// A toystore.
	/// </summary>
	public class ToyStore_Core : TypeCore, IStore
	{
		public ToyStore_Core()
		{
			this._TypeId = 270;
			this._Id = "ToyStore";
			this._Schema_Org_Url = "http://schema.org/ToyStore";
			string label = "";
			GetLabel(out label, "ToyStore", typeof(ToyStore_Core));
			this._Label = label;
