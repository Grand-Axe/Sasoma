...
namespace Sasoma.Microdata.Types
{
	...
	/// A Childcare center.
	/// </summary>
	public class ChildCare_Core : TypeCore, ILocalBusiness
	{
		public ChildCare_Core()
		{
			this._TypeId = 57;
			this._Id = "ChildCare";
			this._Schema_Org_Url = "http://schema.org/ChildCare";
			string label = "";
			GetLabel(out label, "ChildCare", typeof(ChildCare_Core));
			this._Label = label;
