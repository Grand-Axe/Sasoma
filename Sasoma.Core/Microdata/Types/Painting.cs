...
namespace Sasoma.Microdata.Types
{
	...
	/// A painting.
	/// </summary>
	public class Painting_Core : TypeCore, ICreativeWork
	{
		public Painting_Core()
		{
			this._TypeId = 195;
			this._Id = "Painting";
			this._Schema_Org_Url = "http://schema.org/Painting";
			string label = "";
			GetLabel(out label, "Painting", typeof(Painting_Core));
			this._Label = label;
