...
namespace Sasoma.Microdata.Types
{
	...
	/// </summary>
	public class FireStation_Core : TypeCore, ICivicStructure
	{
		public FireStation_Core()
		{
			this._TypeId = 104;
			this._Id = "FireStation";
			this._Schema_Org_Url = "http://schema.org/FireStation";
			string label = "";
			GetLabel(out label, "FireStation", typeof(FireStation_Core));
			this._Label = label;
