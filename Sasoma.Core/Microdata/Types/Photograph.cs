...
namespace Sasoma.Microdata.Types
{
	...
	/// A photograph.
	/// </summary>
	public class Photograph_Core : TypeCore, ICreativeWork
	{
		public Photograph_Core()
		{
			this._TypeId = 204;
			this._Id = "Photograph";
			this._Schema_Org_Url = "http://schema.org/Photograph";
			string label = "";
			GetLabel(out label, "Photograph", typeof(Photograph_Core));
			this._Label = label;
