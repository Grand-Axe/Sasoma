...
namespace Sasoma.Microdata.Types
{
	...
	/// A liquor store.
	/// </summary>
	public class LiquorStore_Core : TypeCore, IStore
	{
		public LiquorStore_Core()
		{
			this._TypeId = 151;
			this._Id = "LiquorStore";
			this._Schema_Org_Url = "http://schema.org/LiquorStore";
			string label = "";
			GetLabel(out label, "LiquorStore", typeof(LiquorStore_Core));
			this._Label = label;
