...
namespace Sasoma.Microdata.Types
{
	...
	/// </summary>
	public class GeneralContractor_Core : TypeCore, IHomeAndConstructionBusiness
	{
		public GeneralContractor_Core()
		{
			this._TypeId = 112;
			this._Id = "GeneralContractor";
			this._Schema_Org_Url = "http://schema.org/GeneralContractor";
			string label = "";
			GetLabel(out label, "GeneralContractor", typeof(GeneralContractor_Core));
			this._Label = label;
