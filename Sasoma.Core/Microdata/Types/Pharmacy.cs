...
namespace Sasoma.Microdata.Types
{
	...
	/// </summary>
	public class Pharmacy_Core : TypeCore, IMedicalOrganization
	{
		public Pharmacy_Core()
		{
			this._TypeId = 203;
			this._Id = "Pharmacy";
			this._Schema_Org_Url = "http://schema.org/Pharmacy";
			string label = "";
			GetLabel(out label, "Pharmacy", typeof(Pharmacy_Core));
			this._Label = label;
