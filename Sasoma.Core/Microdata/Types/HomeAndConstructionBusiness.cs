...
namespace Sasoma.Microdata.Types
{
	...
	/// </summary>
	public class HomeAndConstructionBusiness_Core : TypeCore, ILocalBusiness
	{
		public HomeAndConstructionBusiness_Core()
		{
			this._TypeId = 128;
			this._Id = "HomeAndConstructionBusiness";
			this._Schema_Org_Url = "http://schema.org/HomeAndConstructionBusiness";
			string label = "";
			GetLabel(out label, "HomeAndConstructionBusiness", typeof(HomeAndConstructionBusiness_Core));
			this._Label = label;
			this._Ancestors = new int[]{266,193,155};
			this._SubTypes = new int[]{89,112,120,133,156,172,209,231};
