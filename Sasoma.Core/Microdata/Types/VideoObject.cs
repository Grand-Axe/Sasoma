...
namespace Sasoma.Microdata.Types
{
	...
	{
		public VideoObject_Core()
		{
			this._TypeId = 285;
			this._Id = "VideoObject";
			this._Schema_Org_Url = "http://schema.org/VideoObject";
			string label = "";
			...
			this._Properties = new int[]{67,108,143,229,0,2,10,12,18,20,24,26,21,50,51,54,57,58,59,61,62,64,70,72,81,97,100,110,115,116,126,138,151,178,179,180,199,211,219,230,231,17,31,52,53,71,76,79,80,88,101,160,188,192,228,234,41,176,197,226,232,233};
		...
		/// </summary>
		private VideoFrameSize_Core videoFrameSize;
		public VideoFrameSize_Core VideoFrameSize
		{
			get
			{
			...
			set
			{
				...
				SetPropertyInstance(videoFrameSize);
			}
		}
		...
		/// </summary>
		private VideoQuality_Core videoQuality;
		public VideoQuality_Core VideoQuality
		{
			get
			{
				return videoQuality;
			...
			{
				videoQuality = value;
				SetPropertyInstance(videoQuality);
			}
		}
