...
namespace Sasoma.Microdata.Types
{
	...
	/// An electrician.
	/// </summary>
	public class Electrician_Core : TypeCore, IHomeAndConstructionBusiness
	{
		public Electrician_Core()
		{
			this._TypeId = 89;
			this._Id = "Electrician";
			this._Schema_Org_Url = "http://schema.org/Electrician";
			string label = "";
			GetLabel(out label, "Electrician", typeof(Electrician_Core));
			this._Label = label;
