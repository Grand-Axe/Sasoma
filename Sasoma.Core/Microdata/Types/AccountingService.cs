...
namespace Sasoma.Microdata.Types
{
	...
	/// </summary>
	public class AccountingService_Core : TypeCore, IFinancialService
	{
		public AccountingService_Core()
		{
			this._TypeId = 9;
			this._Id = "AccountingService";
			this._Schema_Org_Url = "http://schema.org/AccountingService";
			string label = "";
			GetLabel(out label, "AccountingService", typeof(AccountingService_Core));
			this._Label = label;
			this._Ancestors = new int[]{266,193,155,103};
			this._SubTypes = new int[0];
			this._SuperTypes = new int[]{216,103};
