...
namespace Sasoma.Microdata.Types
{
	...
	/// A jewelry store.
	/// </summary>
	public class JewelryStore_Core : TypeCore, IStore
	{
		public JewelryStore_Core()
		{
			this._TypeId = 143;
			this._Id = "JewelryStore";
			this._Schema_Org_Url = "http://schema.org/JewelryStore";
			string label = "";
			GetLabel(out label, "JewelryStore", typeof(JewelryStore_Core));
			this._Label = label;
