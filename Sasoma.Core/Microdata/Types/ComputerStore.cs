...
namespace Sasoma.Microdata.Types
{
	...
	/// A computer store.
	/// </summary>
	public class ComputerStore_Core : TypeCore, IStore
	{
		public ComputerStore_Core()
		{
			this._TypeId = 68;
			this._Id = "ComputerStore";
			this._Schema_Org_Url = "http://schema.org/ComputerStore";
			string label = "";
			GetLabel(out label, "ComputerStore", typeof(ComputerStore_Core));
			this._Label = label;
