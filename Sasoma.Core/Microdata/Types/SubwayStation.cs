...
namespace Sasoma.Microdata.Types
{
	...
	/// A subway station.
	/// </summary>
	public class SubwayStation_Core : TypeCore, ICivicStructure
	{
		public SubwayStation_Core()
		{
			this._TypeId = 254;
			this._Id = "SubwayStation";
			this._Schema_Org_Url = "http://schema.org/SubwayStation";
			string label = "";
			GetLabel(out label, "SubwayStation", typeof(SubwayStation_Core));
			this._Label = label;
