...
namespace Sasoma.Microdata.Types
{
	...
	/// </summary>
	public class CreativeWork_Core : TypeCore, IThing
	{
		public CreativeWork_Core()
		{
			this._TypeId = 78;
			this._Id = "CreativeWork";
			this._Schema_Org_Url = "http://schema.org/CreativeWork";
			string label = "";
			GetLabel(out label, "CreativeWork", typeof(CreativeWork_Core));
			this._Label = label;
			this._Ancestors = new int[]{266};
			this._SubTypes = new int[]{20,38,41,141,158,161,169,177,178,195,204,224,229,235,256,257,258,293,294};
