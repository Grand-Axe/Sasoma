...
namespace Sasoma.Microdata.Types
{
	...
	/// </summary>
	public class TelevisionStation_Core : TypeCore, ILocalBusiness
	{
		public TelevisionStation_Core()
		{
			this._TypeId = 262;
			this._Id = "TelevisionStation";
			this._Schema_Org_Url = "http://schema.org/TelevisionStation";
			string label = "";
			GetLabel(out label, "TelevisionStation", typeof(TelevisionStation_Core));
			this._Label = label;
