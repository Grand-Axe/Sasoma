...
namespace Sasoma.Microdata.Types
{
	...
	/// Aquarium.
	/// </summary>
	public class Aquarium_Core : TypeCore, ICivicStructure
	{
		public Aquarium_Core()
		{
			this._TypeId = 18;
			this._Id = "Aquarium";
			this._Schema_Org_Url = "http://schema.org/Aquarium";
			string label = "";
			GetLabel(out label, "Aquarium", typeof(Aquarium_Core));
			this._Label = label;
