...
namespace Sasoma.Microdata.Types
{
	...
	/// </summary>
	public class WPHeader_Core : TypeCore, IWebPageElement
	{
		public WPHeader_Core()
		{
			this._TypeId = 290;
			this._Id = "WPHeader";
			this._Schema_Org_Url = "http://schema.org/WPHeader";
			string label = "";
			GetLabel(out label, "WPHeader", typeof(WPHeader_Core));
			this._Label = label;
