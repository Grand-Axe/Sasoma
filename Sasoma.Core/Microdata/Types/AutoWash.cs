...
namespace Sasoma.Microdata.Types
{
	...
	/// A car wash business.
	/// </summary>
	public class AutoWash_Core : TypeCore, IAutomotiveBusiness
	{
		public AutoWash_Core()
		{
			this._TypeId = 28;
			this._Id = "AutoWash";
			this._Schema_Org_Url = "http://schema.org/AutoWash";
			string label = "";
			GetLabel(out label, "AutoWash", typeof(AutoWash_Core));
			this._Label = label;
