...
namespace Sasoma.Microdata.Types
{
	...
	/// An art gallery.
	/// </summary>
	public class ArtGallery_Core : TypeCore, IEntertainmentBusiness
	{
		public ArtGallery_Core()
		{
			this._TypeId = 19;
			this._Id = "ArtGallery";
			this._Schema_Org_Url = "http://schema.org/ArtGallery";
			string label = "";
			GetLabel(out label, "ArtGallery", typeof(ArtGallery_Core));
			this._Label = label;
