...
namespace Sasoma.Microdata.Types
{
	...
	/// A medical clinic.
	/// </summary>
	public class MedicalClinic_Core : TypeCore, IMedicalOrganization
	{
		public MedicalClinic_Core()
		{
			this._TypeId = 162;
			this._Id = "MedicalClinic";
			this._Schema_Org_Url = "http://schema.org/MedicalClinic";
			string label = "";
			GetLabel(out label, "MedicalClinic", typeof(MedicalClinic_Core));
			this._Label = label;
