...
namespace Sasoma.Microdata.Types
{
	...
	/// A motorcycle dealer.
	/// </summary>
	public class MotorcycleDealer_Core : TypeCore, IAutomotiveBusiness
	{
		public MotorcycleDealer_Core()
		{
			this._TypeId = 160;
			this._Id = "MotorcycleDealer";
			this._Schema_Org_Url = "http://schema.org/MotorcycleDealer";
			string label = "";
			GetLabel(out label, "MotorcycleDealer", typeof(MotorcycleDealer_Core));
			this._Label = label;
