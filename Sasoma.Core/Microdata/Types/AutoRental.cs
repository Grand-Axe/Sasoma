...
namespace Sasoma.Microdata.Types
{
	...
	/// </summary>
	public class AutoRental_Core : TypeCore, IAutomotiveBusiness
	{
		public AutoRental_Core()
		{
			this._TypeId = 26;
			this._Id = "AutoRental";
			this._Schema_Org_Url = "http://schema.org/AutoRental";
			string label = "";
			GetLabel(out label, "AutoRental", typeof(AutoRental_Core));
			this._Label = label;
