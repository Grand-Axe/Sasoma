...
namespace Sasoma.Microdata.Types
{
	...
	/// A music venue.
	/// </summary>
	public class MusicVenue_Core : TypeCore, ICivicStructure
	{
		public MusicVenue_Core()
		{
			this._TypeId = 180;
			this._Id = "MusicVenue";
			this._Schema_Org_Url = "http://schema.org/MusicVenue";
			string label = "";
			GetLabel(out label, "MusicVenue", typeof(MusicVenue_Core));
			this._Label = label;
