...
namespace Sasoma.Microdata.Types
{
	...
	/// A ski resort.
	/// </summary>
	public class SkiResort_Core : TypeCore, ISportsActivityLocation
	{
		public SkiResort_Core()
		{
			this._TypeId = 243;
			this._Id = "SkiResort";
			this._Schema_Org_Url = "http://schema.org/SkiResort";
			string label = "";
			GetLabel(out label, "SkiResort", typeof(SkiResort_Core));
			this._Label = label;
