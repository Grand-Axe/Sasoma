...
namespace Sasoma.Microdata.Types
{
	...
	/// A news article
	/// </summary>
	public class NewsArticle_Core : TypeCore, IArticle
	{
		public NewsArticle_Core()
		{
			this._TypeId = 184;
			this._Id = "NewsArticle";
			this._Schema_Org_Url = "http://schema.org/NewsArticle";
			string label = "";
			GetLabel(out label, "NewsArticle", typeof(NewsArticle_Core));
			this._Label = label;
			this._Ancestors = new int[]{266,78,20};
			this._SubTypes = new int[0];
			this._SuperTypes = new int[]{20};
			this._Properties = new int[]{67,108,143,229,0,2,10,12,18,20,24,26,21,50,51,54,57,58,59,61,62,64,70,72,81,97,100,110,115,116,126,138,151,178,179,180,199,211,219,230,231,15,16,235,65,170,171,172,173};
		...
		/// </summary>
		private Dateline_Core dateline;
		public Dateline_Core Dateline
		{
			get
			{
				return dateline;
		...
		/// </summary>
		private PrintColumn_Core printColumn;
		public PrintColumn_Core PrintColumn
		{
			get
			{
				return printColumn;
			...
			{
				printColumn = value;
				SetPropertyInstance(printColumn);
			}
		}
		...
		/// </summary>
		private PrintEdition_Core printEdition;
		public PrintEdition_Core PrintEdition
		{
			get
			{
				return printEdition;
			...
			{
				printEdition = value;
				SetPropertyInstance(printEdition);
			}
		}
		...
		/// </summary>
		private PrintPage_Core printPage;
		public PrintPage_Core PrintPage
		{
			get
			{
				return printPage;
		...
		/// </summary>
		private PrintSection_Core printSection;
		public PrintSection_Core PrintSection
		{
			get
			{
				return printSection;
			...
			{
				printSection = value;
				SetPropertyInstance(printSection);
			}
		}
