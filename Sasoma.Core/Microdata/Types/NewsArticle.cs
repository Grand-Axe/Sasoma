...
namespace Sasoma.Microdata.Types
{
	...
	public class NewsArticle_Core : TypeCore, IArticle
	{
		...
		/// </summary>
		public ArticleBody_Core ArticleBody { get; set; }

		/// <summary>
		/// Articles may belong to one or more 'sections' in a magazine or newspaper, such as Sports, Lifestyle, etc.
		/// </summary>
		public ArticleSection_Core ArticleSection { get; set; }
		...
		/// </summary>
		public Dateline_Core Dateline { get; set; }
		...
		/// </summary>
		public PrintColumn_Core PrintColumn { get; set; }

		/// <summary>
		/// The edition of the print product in which the NewsArticle appears.
		/// </summary>
		public PrintEdition_Core PrintEdition { get; set; }

		/// <summary>
		/// If this NewsArticle appears in print, this field indicates the name of the page on which the article is found. Please note that this field is intended for the exact page name (e.g. A5, B18).
		/// </summary>
		public PrintPage_Core PrintPage { get; set; }

		/// <summary>
		/// If this NewsArticle appears in print, this field indicates the print section in which the article appeared.
		/// </summary>
		public PrintSection_Core PrintSection { get; set; }
		...
		/// </summary>
		public WordCount_Core WordCount { get; set; }
