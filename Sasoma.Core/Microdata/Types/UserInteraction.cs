...
namespace Sasoma.Microdata.Types
{
	...
	/// </summary>
	public class UserInteraction_Core : TypeCore, IEvent
	{
		public UserInteraction_Core()
		{
			this._TypeId = 277;
			this._Id = "UserInteraction";
			this._Schema_Org_Url = "http://schema.org/UserInteraction";
			string label = "";
			GetLabel(out label, "UserInteraction", typeof(UserInteraction_Core));
			this._Label = label;
			this._Ancestors = new int[]{266,98};
			this._SubTypes = new int[]{273,274,275,276,278,279,280,281,282};
