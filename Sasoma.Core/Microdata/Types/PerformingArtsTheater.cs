...
namespace Sasoma.Microdata.Types
{
	...
	/// </summary>
	public class PerformingArtsTheater_Core : TypeCore, ICivicStructure
	{
		public PerformingArtsTheater_Core()
		{
			this._TypeId = 199;
			this._Id = "PerformingArtsTheater";
			this._Schema_Org_Url = "http://schema.org/PerformingArtsTheater";
			string label = "";
			GetLabel(out label, "PerformingArtsTheater", typeof(PerformingArtsTheater_Core));
			this._Label = label;
