...
namespace Sasoma.Microdata.Types
{
	...
	/// A recycling center.
	/// </summary>
	public class RecyclingCenter_Core : TypeCore, ILocalBusiness
	{
		public RecyclingCenter_Core()
		{
			this._TypeId = 225;
			this._Id = "RecyclingCenter";
			this._Schema_Org_Url = "http://schema.org/RecyclingCenter";
			string label = "";
			GetLabel(out label, "RecyclingCenter", typeof(RecyclingCenter_Core));
			this._Label = label;
