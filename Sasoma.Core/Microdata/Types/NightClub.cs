...
namespace Sasoma.Microdata.Types
{
	...
	/// </summary>
	public class NightClub_Core : TypeCore, IEntertainmentBusiness
	{
		public NightClub_Core()
		{
			this._TypeId = 185;
			this._Id = "NightClub";
			this._Schema_Org_Url = "http://schema.org/NightClub";
			string label = "";
			GetLabel(out label, "NightClub", typeof(NightClub_Core));
			this._Label = label;
