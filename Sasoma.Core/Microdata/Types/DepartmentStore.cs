...
namespace Sasoma.Microdata.Types
{
	...
	/// A department store.
	/// </summary>
	public class DepartmentStore_Core : TypeCore, IStore
	{
		public DepartmentStore_Core()
		{
			this._TypeId = 85;
			this._Id = "DepartmentStore";
			this._Schema_Org_Url = "http://schema.org/DepartmentStore";
			string label = "";
			GetLabel(out label, "DepartmentStore", typeof(DepartmentStore_Core));
			this._Label = label;
