...
namespace Sasoma.Microdata.Types
{
	...
	/// </summary>
	public class MobilePhoneStore_Core : TypeCore, IStore
	{
		public MobilePhoneStore_Core()
		{
			this._TypeId = 166;
			this._Id = "MobilePhoneStore";
			this._Schema_Org_Url = "http://schema.org/MobilePhoneStore";
			string label = "";
			GetLabel(out label, "MobilePhoneStore", typeof(MobilePhoneStore_Core));
			this._Label = label;
