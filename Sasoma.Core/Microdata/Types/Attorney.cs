...
namespace Sasoma.Microdata.Types
{
	...
	/// </summary>
	public class Attorney_Core : TypeCore, IProfessionalService
	{
		public Attorney_Core()
		{
			this._TypeId = 21;
			this._Id = "Attorney";
			this._Schema_Org_Url = "http://schema.org/Attorney";
			string label = "";
			GetLabel(out label, "Attorney", typeof(Attorney_Core));
			this._Label = label;
			this._Ancestors = new int[]{266,193,155,216};
			this._SubTypes = new int[0];
			this._SuperTypes = new int[]{216};
