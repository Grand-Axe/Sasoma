...
namespace Sasoma.Microdata.Types
{
	...
	/// A bike store.
	/// </summary>
	public class BikeStore_Core : TypeCore, IStore
	{
		public BikeStore_Core()
		{
			this._TypeId = 37;
			this._Id = "BikeStore";
			this._Schema_Org_Url = "http://schema.org/BikeStore";
			string label = "";
			GetLabel(out label, "BikeStore", typeof(BikeStore_Core));
			this._Label = label;
