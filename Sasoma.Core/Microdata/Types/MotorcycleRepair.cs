...
namespace Sasoma.Microdata.Types
{
	...
	/// </summary>
	public class MotorcycleRepair_Core : TypeCore, IAutomotiveBusiness
	{
		public MotorcycleRepair_Core()
		{
			this._TypeId = 167;
			this._Id = "MotorcycleRepair";
			this._Schema_Org_Url = "http://schema.org/MotorcycleRepair";
			string label = "";
			GetLabel(out label, "MotorcycleRepair", typeof(MotorcycleRepair_Core));
			this._Label = label;
