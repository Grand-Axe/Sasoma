...
namespace Sasoma.Microdata.Types
{
	...
	/// </summary>
	public class VideoGallery_Core : TypeCore, ICollectionPage
	{
		public VideoGallery_Core()
		{
			this._TypeId = 284;
			this._Id = "VideoGallery";
			this._Schema_Org_Url = "http://schema.org/VideoGallery";
			string label = "";
			GetLabel(out label, "VideoGallery", typeof(VideoGallery_Core));
			this._Label = label;
