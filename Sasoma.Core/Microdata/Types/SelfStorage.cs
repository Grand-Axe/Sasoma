...
namespace Sasoma.Microdata.Types
{
	...
	/// </summary>
	public class SelfStorage_Core : TypeCore, ILocalBusiness
	{
		public SelfStorage_Core()
		{
			this._TypeId = 238;
			this._Id = "SelfStorage";
			this._Schema_Org_Url = "http://schema.org/SelfStorage";
			string label = "";
			GetLabel(out label, "SelfStorage", typeof(SelfStorage_Core));
			this._Label = label;
