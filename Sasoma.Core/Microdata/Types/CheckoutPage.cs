...
namespace Sasoma.Microdata.Types
{
	...
	/// </summary>
	public class CheckoutPage_Core : TypeCore, IWebPage
	{
		public CheckoutPage_Core()
		{
			this._TypeId = 56;
			this._Id = "CheckoutPage";
			this._Schema_Org_Url = "http://schema.org/CheckoutPage";
			string label = "";
			GetLabel(out label, "CheckoutPage", typeof(CheckoutPage_Core));
			this._Label = label;
