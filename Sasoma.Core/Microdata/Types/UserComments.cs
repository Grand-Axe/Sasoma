...
namespace Sasoma.Microdata.Types
{
	...
	{
		public UserComments_Core()
		{
			this._TypeId = 275;
			this._Id = "UserComments";
			this._Schema_Org_Url = "http://schema.org/UserComments";
			string label = "";
			...
			this._Properties = new int[]{67,108,143,229,19,71,82,130,151,158,214,216,218,22,23,59,69,190};
		...
		/// </summary>
		private CommentText_Core commentText;
		public CommentText_Core CommentText
		{
			get
			{
				return commentText;
			...
			{
				commentText = value;
				SetPropertyInstance(commentText);
			}
		}
		...
		/// </summary>
		private CommentTime_Core commentTime;
		public CommentTime_Core CommentTime
		{
			get
			{
				return commentTime;
			...
			{
				commentTime = value;
				SetPropertyInstance(commentTime);
			}
		}
		...
		/// </summary>
		private Discusses_Core discusses;
		public Discusses_Core Discusses
		{
			get
			{
				return discusses;
		...
		/// </summary>
		private ReplyToURL_Core replyToURL;
		public ReplyToURL_Core ReplyToURL
		{
			get
			{
				return replyToURL;
			...
			{
				replyToURL = value;
				SetPropertyInstance(replyToURL);
			}
		}
