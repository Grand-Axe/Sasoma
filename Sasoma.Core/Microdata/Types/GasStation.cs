...
namespace Sasoma.Microdata.Types
{
	...
	/// A gas station.
	/// </summary>
	public class GasStation_Core : TypeCore, IAutomotiveBusiness
	{
		public GasStation_Core()
		{
			this._TypeId = 110;
			this._Id = "GasStation";
			this._Schema_Org_Url = "http://schema.org/GasStation";
			string label = "";
			GetLabel(out label, "GasStation", typeof(GasStation_Core));
			this._Label = label;
