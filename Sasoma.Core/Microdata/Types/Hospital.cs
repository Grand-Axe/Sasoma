...
namespace Sasoma.Microdata.Types
{
	...
	/// A hospital.
	/// </summary>
	public class Hospital_Core : TypeCore, IMedicalOrganization
	{
		public Hospital_Core()
		{
			this._TypeId = 130;
			this._Id = "Hospital";
			this._Schema_Org_Url = "http://schema.org/Hospital";
			string label = "";
			GetLabel(out label, "Hospital", typeof(Hospital_Core));
			this._Label = label;
			this._Ancestors = new int[]{266,193,155,163};
			this._SubTypes = new int[0];
			this._SuperTypes = new int[]{62,163,93};
