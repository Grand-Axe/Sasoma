...
namespace Sasoma.Microdata.Types
{
	...
	/// A sports club.
	/// </summary>
	public class SportsClub_Core : TypeCore, ISportsActivityLocation
	{
		public SportsClub_Core()
		{
			this._TypeId = 247;
			this._Id = "SportsClub";
			this._Schema_Org_Url = "http://schema.org/SportsClub";
			string label = "";
			GetLabel(out label, "SportsClub", typeof(SportsClub_Core));
			this._Label = label;
