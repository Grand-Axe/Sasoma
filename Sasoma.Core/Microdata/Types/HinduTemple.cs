...
namespace Sasoma.Microdata.Types
{
	...
	/// A Hindu temple.
	/// </summary>
	public class HinduTemple_Core : TypeCore, IPlaceOfWorship
	{
		public HinduTemple_Core()
		{
			this._TypeId = 126;
			this._Id = "HinduTemple";
			this._Schema_Org_Url = "http://schema.org/HinduTemple";
			string label = "";
			GetLabel(out label, "HinduTemple", typeof(HinduTemple_Core));
			this._Label = label;
