...
namespace Sasoma.Microdata.Types
{
	...
	/// A country.
	/// </summary>
	public class Country_Core : TypeCore, IAdministrativeArea
	{
		public int TypeId
		{
			get
		...
		public string Schema_Org_Url
		{
			get
			{
				return "http://schema.org/Country";
			}
		}
		...
		public string Label
		{
			get
			{
				GetLabel(out label, "Country", typeof(Country_Core));
				return label;
			}
		}
