...
namespace Sasoma.Microdata.Types
{
	...
	/// An outlet store.
	/// </summary>
	public class OutletStore_Core : TypeCore, IStore
	{
		public OutletStore_Core()
		{
			this._TypeId = 194;
			this._Id = "OutletStore";
			this._Schema_Org_Url = "http://schema.org/OutletStore";
			string label = "";
			GetLabel(out label, "OutletStore", typeof(OutletStore_Core));
			this._Label = label;
