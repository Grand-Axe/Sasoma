...
namespace Sasoma.Microdata.Types
{
	...
	/// </summary>
	public class ComedyEvent_Core : TypeCore, IEvent
	{
		public ComedyEvent_Core()
		{
			this._TypeId = 67;
			this._Id = "ComedyEvent";
			this._Schema_Org_Url = "http://schema.org/ComedyEvent";
			string label = "";
			GetLabel(out label, "ComedyEvent", typeof(ComedyEvent_Core));
			this._Label = label;
