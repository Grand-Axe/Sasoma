...
namespace Sasoma.Microdata.Types
{
	...
	/// ATM/cash machine.
	/// </summary>
	public class AutomatedTeller_Core : TypeCore, IFinancialService
	{
		public AutomatedTeller_Core()
		{
			this._TypeId = 29;
			this._Id = "AutomatedTeller";
			this._Schema_Org_Url = "http://schema.org/AutomatedTeller";
			string label = "";
			GetLabel(out label, "AutomatedTeller", typeof(AutomatedTeller_Core));
			this._Label = label;
