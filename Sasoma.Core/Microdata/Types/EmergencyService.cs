...
namespace Sasoma.Microdata.Types
{
	...
	/// </summary>
	public class EmergencyService_Core : TypeCore, ILocalBusiness
	{
		public EmergencyService_Core()
		{
			this._TypeId = 93;
			this._Id = "EmergencyService";
			this._Schema_Org_Url = "http://schema.org/EmergencyService";
			string label = "";
			GetLabel(out label, "EmergencyService", typeof(EmergencyService_Core));
			this._Label = label;
			this._Ancestors = new int[]{266,193,155};
			this._SubTypes = new int[]{104,130,210};
