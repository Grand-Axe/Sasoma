...
namespace Sasoma.Microdata.Types
{
	...
	/// </summary>
	public class EmploymentAgency_Core : TypeCore, ILocalBusiness
	{
		public EmploymentAgency_Core()
		{
			this._TypeId = 94;
			this._Id = "EmploymentAgency";
			this._Schema_Org_Url = "http://schema.org/EmploymentAgency";
			string label = "";
			GetLabel(out label, "EmploymentAgency", typeof(EmploymentAgency_Core));
			this._Label = label;
