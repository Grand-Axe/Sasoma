...
namespace Sasoma.Microdata.Types
{
	...
	/// A hobby store.
	/// </summary>
	public class HobbyShop_Core : TypeCore, IStore
	{
		public HobbyShop_Core()
		{
			this._TypeId = 127;
			this._Id = "HobbyShop";
			this._Schema_Org_Url = "http://schema.org/HobbyShop";
			string label = "";
			GetLabel(out label, "HobbyShop", typeof(HobbyShop_Core));
			this._Label = label;
