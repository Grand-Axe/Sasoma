...
namespace Sasoma.Microdata.Types
{
	...
	/// </summary>
	public class TouristAttraction_Core : TypeCore, IPlace
	{
		public TouristAttraction_Core()
		{
			this._TypeId = 268;
			this._Id = "TouristAttraction";
			this._Schema_Org_Url = "http://schema.org/TouristAttraction";
			string label = "";
			GetLabel(out label, "TouristAttraction", typeof(TouristAttraction_Core));
			this._Label = label;
