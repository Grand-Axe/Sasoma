...
namespace Sasoma.Microdata.Types
{
	...
	/// </summary>
	public class FoodEvent_Core : TypeCore, IEvent
	{
		public FoodEvent_Core()
		{
			this._TypeId = 107;
			this._Id = "FoodEvent";
			this._Schema_Org_Url = "http://schema.org/FoodEvent";
			string label = "";
			GetLabel(out label, "FoodEvent", typeof(FoodEvent_Core));
			this._Label = label;
