...
namespace Sasoma.Microdata.Types
{
	...
	/// A stadium.
	/// </summary>
	public class StadiumOrArena_Core : TypeCore, ICivicStructure
	{
		public StadiumOrArena_Core()
		{
			this._TypeId = 250;
			this._Id = "StadiumOrArena";
			this._Schema_Org_Url = "http://schema.org/StadiumOrArena";
			string label = "";
			GetLabel(out label, "StadiumOrArena", typeof(StadiumOrArena_Core));
			this._Label = label;
			this._Ancestors = new int[]{266,206,62};
			this._SubTypes = new int[0];
			this._SuperTypes = new int[]{62,246};
