...
namespace Sasoma.Microdata.Types
{
	...
	/// A moving company.
	/// </summary>
	public class MovingCompany_Core : TypeCore, IHomeAndConstructionBusiness
	{
		public MovingCompany_Core()
		{
			this._TypeId = 172;
			this._Id = "MovingCompany";
			this._Schema_Org_Url = "http://schema.org/MovingCompany";
			string label = "";
			GetLabel(out label, "MovingCompany", typeof(MovingCompany_Core));
			this._Label = label;
