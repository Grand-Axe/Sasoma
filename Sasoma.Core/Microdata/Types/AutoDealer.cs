...
namespace Sasoma.Microdata.Types
{
	...
	/// An car dealership.
	/// </summary>
	public class AutoDealer_Core : TypeCore, IAutomotiveBusiness
	{
		public AutoDealer_Core()
		{
			this._TypeId = 24;
			this._Id = "AutoDealer";
			this._Schema_Org_Url = "http://schema.org/AutoDealer";
			string label = "";
			GetLabel(out label, "AutoDealer", typeof(AutoDealer_Core));
			this._Label = label;
