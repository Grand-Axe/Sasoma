...
namespace Sasoma.Microdata.Types
{
	...
	/// </summary>
	public class Mountain_Core : TypeCore, ILandform
	{
		public Mountain_Core()
		{
			this._TypeId = 168;
			this._Id = "Mountain";
			this._Schema_Org_Url = "http://schema.org/Mountain";
			string label = "";
			GetLabel(out label, "Mountain", typeof(Mountain_Core));
			this._Label = label;
