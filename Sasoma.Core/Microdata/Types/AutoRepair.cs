...
namespace Sasoma.Microdata.Types
{
	...
	/// Car repair business.
	/// </summary>
	public class AutoRepair_Core : TypeCore, IAutomotiveBusiness
	{
		public AutoRepair_Core()
		{
			this._TypeId = 27;
			this._Id = "AutoRepair";
			this._Schema_Org_Url = "http://schema.org/AutoRepair";
			string label = "";
			GetLabel(out label, "AutoRepair", typeof(AutoRepair_Core));
			this._Label = label;
