...
namespace Sasoma.Microdata.Types
{
	...
	/// A locksmith.
	/// </summary>
	public class Locksmith_Core : TypeCore, IHomeAndConstructionBusiness
	{
		public Locksmith_Core()
		{
			this._TypeId = 156;
			this._Id = "Locksmith";
			this._Schema_Org_Url = "http://schema.org/Locksmith";
			string label = "";
			GetLabel(out label, "Locksmith", typeof(Locksmith_Core));
			this._Label = label;
