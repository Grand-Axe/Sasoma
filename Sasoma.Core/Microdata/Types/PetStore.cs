...
namespace Sasoma.Microdata.Types
{
	...
	/// A pet store.
	/// </summary>
	public class PetStore_Core : TypeCore, IStore
	{
		public PetStore_Core()
		{
			this._TypeId = 202;
			this._Id = "PetStore";
			this._Schema_Org_Url = "http://schema.org/PetStore";
			string label = "";
			GetLabel(out label, "PetStore", typeof(PetStore_Core));
			this._Label = label;
