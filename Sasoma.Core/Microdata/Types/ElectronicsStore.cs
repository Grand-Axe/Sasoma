...
namespace Sasoma.Microdata.Types
{
	...
	/// </summary>
	public class ElectronicsStore_Core : TypeCore, IStore
	{
		public ElectronicsStore_Core()
		{
			this._TypeId = 90;
			this._Id = "ElectronicsStore";
			this._Schema_Org_Url = "http://schema.org/ElectronicsStore";
			string label = "";
			GetLabel(out label, "ElectronicsStore", typeof(ElectronicsStore_Core));
			this._Label = label;
