...
namespace Sasoma.Microdata.Types
{
	...
	/// Insurance agency.
	/// </summary>
	public class InsuranceAgency_Core : TypeCore, IFinancialService
	{
		public InsuranceAgency_Core()
		{
			this._TypeId = 137;
			this._Id = "InsuranceAgency";
			this._Schema_Org_Url = "http://schema.org/InsuranceAgency";
			string label = "";
			GetLabel(out label, "InsuranceAgency", typeof(InsuranceAgency_Core));
			this._Label = label;
