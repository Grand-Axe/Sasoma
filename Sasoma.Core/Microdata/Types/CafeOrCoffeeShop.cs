...
namespace Sasoma.Microdata.Types
{
	...
	/// </summary>
	public class CafeOrCoffeeShop_Core : TypeCore, IFoodEstablishment
	{
		public CafeOrCoffeeShop_Core()
		{
			this._TypeId = 50;
			this._Id = "CafeOrCoffeeShop";
			this._Schema_Org_Url = "http://schema.org/CafeOrCoffeeShop";
			string label = "";
			GetLabel(out label, "CafeOrCoffeeShop", typeof(CafeOrCoffeeShop_Core));
			this._Label = label;
