...
namespace Sasoma.Microdata.Types
{
	...
	/// A gym.
	/// </summary>
	public class ExerciseGym_Core : TypeCore, ISportsActivityLocation
	{
		public ExerciseGym_Core()
		{
			this._TypeId = 100;
			this._Id = "ExerciseGym";
			this._Schema_Org_Url = "http://schema.org/ExerciseGym";
			string label = "";
			GetLabel(out label, "ExerciseGym", typeof(ExerciseGym_Core));
			this._Label = label;
