...
namespace Sasoma.Microdata.Types
{
	...
	/// </summary>
	public class CollegeOrUniversity_Core : TypeCore, IEducationalOrganization
	{
		public CollegeOrUniversity_Core()
		{
			this._TypeId = 65;
			this._Id = "CollegeOrUniversity";
			this._Schema_Org_Url = "http://schema.org/CollegeOrUniversity";
			string label = "";
			GetLabel(out label, "CollegeOrUniversity", typeof(CollegeOrUniversity_Core));
			this._Label = label;
