...
namespace Sasoma.Microdata.Types
{
	...
	/// </summary>
	public class UserCheckins_Core : TypeCore, IUserInteraction
	{
		public UserCheckins_Core()
		{
			this._TypeId = 274;
			this._Id = "UserCheckins";
			this._Schema_Org_Url = "http://schema.org/UserCheckins";
			string label = "";
			GetLabel(out label, "UserCheckins", typeof(UserCheckins_Core));
			this._Label = label;
