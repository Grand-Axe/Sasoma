...
namespace Sasoma.Microdata.Types
{
	...
	/// Animal shelter.
	/// </summary>
	public class AnimalShelter_Core : TypeCore, ILocalBusiness
	{
		public AnimalShelter_Core()
		{
			this._TypeId = 16;
			this._Id = "AnimalShelter";
			this._Schema_Org_Url = "http://schema.org/AnimalShelter";
			string label = "";
			GetLabel(out label, "AnimalShelter", typeof(AnimalShelter_Core));
			this._Label = label;
