...
namespace Sasoma.Microdata.Types
{
	...
	/// </summary>
	public class UserTweets_Core : TypeCore, IUserInteraction
	{
		public UserTweets_Core()
		{
			this._TypeId = 282;
			this._Id = "UserTweets";
			this._Schema_Org_Url = "http://schema.org/UserTweets";
			string label = "";
			GetLabel(out label, "UserTweets", typeof(UserTweets_Core));
			this._Label = label;
