...
namespace Sasoma.Microdata.Types
{
	...
	/// Bed and breakfast.
	/// </summary>
	public class BedAndBreakfast_Core : TypeCore, ILodgingBusiness
	{
		public BedAndBreakfast_Core()
		{
			this._TypeId = 36;
			this._Id = "BedAndBreakfast";
			this._Schema_Org_Url = "http://schema.org/BedAndBreakfast";
			string label = "";
			GetLabel(out label, "BedAndBreakfast", typeof(BedAndBreakfast_Core));
			this._Label = label;
			this._Ancestors = new int[]{266,193,155,157};
			this._SubTypes = new int[0];
			this._SuperTypes = new int[]{157};
