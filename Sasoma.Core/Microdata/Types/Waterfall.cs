...
namespace Sasoma.Microdata.Types
{
	...
	/// </summary>
	public class Waterfall_Core : TypeCore, IBodyOfWater
	{
		public Waterfall_Core()
		{
			this._TypeId = 292;
			this._Id = "Waterfall";
			this._Schema_Org_Url = "http://schema.org/Waterfall";
			string label = "";
			GetLabel(out label, "Waterfall", typeof(Waterfall_Core));
			this._Label = label;
