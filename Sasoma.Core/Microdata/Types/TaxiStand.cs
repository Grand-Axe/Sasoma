...
namespace Sasoma.Microdata.Types
{
	...
	/// A taxi stand.
	/// </summary>
	public class TaxiStand_Core : TypeCore, ICivicStructure
	{
		public TaxiStand_Core()
		{
			this._TypeId = 261;
			this._Id = "TaxiStand";
			this._Schema_Org_Url = "http://schema.org/TaxiStand";
			string label = "";
			GetLabel(out label, "TaxiStand", typeof(TaxiStand_Core));
			this._Label = label;
