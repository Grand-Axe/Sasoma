...
namespace Sasoma.Microdata.Types
{
	...
	/// </summary>
	public class LegislativeBuilding_Core : TypeCore, IGovernmentBuilding
	{
		public LegislativeBuilding_Core()
		{
			this._TypeId = 149;
			this._Id = "LegislativeBuilding";
			this._Schema_Org_Url = "http://schema.org/LegislativeBuilding";
			string label = "";
			GetLabel(out label, "LegislativeBuilding", typeof(LegislativeBuilding_Core));
			this._Label = label;
