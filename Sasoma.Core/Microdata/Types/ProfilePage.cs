...
namespace Sasoma.Microdata.Types
{
	...
	/// </summary>
	public class ProfilePage_Core : TypeCore, IWebPage
	{
		public ProfilePage_Core()
		{
			this._TypeId = 217;
			this._Id = "ProfilePage";
			this._Schema_Org_Url = "http://schema.org/ProfilePage";
			string label = "";
			GetLabel(out label, "ProfilePage", typeof(ProfilePage_Core));
			this._Label = label;
