...
namespace Sasoma.Microdata.Types
{
	...
	/// </summary>
	public class CollectionPage_Core : TypeCore, IWebPage
	{
		public CollectionPage_Core()
		{
			this._TypeId = 64;
			this._Id = "CollectionPage";
			this._Schema_Org_Url = "http://schema.org/CollectionPage";
			string label = "";
			GetLabel(out label, "CollectionPage", typeof(CollectionPage_Core));
			this._Label = label;
			this._Ancestors = new int[]{266,78,293};
			this._SubTypes = new int[]{135,284};
			this._SuperTypes = new int[]{293};
		...
		/// </summary>
		public Breadcrumb_Core Breadcrumb { get; set; }
		...
		/// </summary>
		public IsPartOf_Core IsPartOf { get; set; }
		...
		/// </summary>
		public MainContentOfPage_Core MainContentOfPage { get; set; }
		...
		/// </summary>
		public PrimaryImageOfPage_Core PrimaryImageOfPage { get; set; }
		...
		/// </summary>
		public SignificantLinks_Core SignificantLinks { get; set; }
