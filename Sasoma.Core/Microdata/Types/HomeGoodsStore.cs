...
namespace Sasoma.Microdata.Types
{
	...
	/// A home goods store.
	/// </summary>
	public class HomeGoodsStore_Core : TypeCore, IStore
	{
		public HomeGoodsStore_Core()
		{
			this._TypeId = 129;
			this._Id = "HomeGoodsStore";
			this._Schema_Org_Url = "http://schema.org/HomeGoodsStore";
			string label = "";
			GetLabel(out label, "HomeGoodsStore", typeof(HomeGoodsStore_Core));
			this._Label = label;
