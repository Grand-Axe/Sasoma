...
namespace Sasoma.Microdata.Types
{
	...
	/// </summary>
	public class ShoppingCenter_Core : TypeCore, ILocalBusiness
	{
		public ShoppingCenter_Core()
		{
			this._TypeId = 240;
			this._Id = "ShoppingCenter";
			this._Schema_Org_Url = "http://schema.org/ShoppingCenter";
			string label = "";
			GetLabel(out label, "ShoppingCenter", typeof(ShoppingCenter_Core));
			this._Label = label;
