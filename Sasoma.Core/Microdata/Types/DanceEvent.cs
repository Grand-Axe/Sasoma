...
namespace Sasoma.Microdata.Types
{
	...
	/// </summary>
	public class DanceEvent_Core : TypeCore, IEvent
	{
		public DanceEvent_Core()
		{
			this._TypeId = 80;
			this._Id = "DanceEvent";
			this._Schema_Org_Url = "http://schema.org/DanceEvent";
			string label = "";
			GetLabel(out label, "DanceEvent", typeof(DanceEvent_Core));
			this._Label = label;
