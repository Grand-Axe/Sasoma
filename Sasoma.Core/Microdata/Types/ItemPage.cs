...
namespace Sasoma.Microdata.Types
{
	...
	/// </summary>
	public class ItemPage_Core : TypeCore, IWebPage
	{
		public ItemPage_Core()
		{
			this._TypeId = 142;
			this._Id = "ItemPage";
			this._Schema_Org_Url = "http://schema.org/ItemPage";
			string label = "";
			GetLabel(out label, "ItemPage", typeof(ItemPage_Core));
			this._Label = label;
