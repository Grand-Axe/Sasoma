...
namespace Sasoma.Microdata.Types
{
	...
	/// </summary>
	public class FastFoodRestaurant_Core : TypeCore, IFoodEstablishment
	{
		public FastFoodRestaurant_Core()
		{
			this._TypeId = 101;
			this._Id = "FastFoodRestaurant";
			this._Schema_Org_Url = "http://schema.org/FastFoodRestaurant";
			string label = "";
			GetLabel(out label, "FastFoodRestaurant", typeof(FastFoodRestaurant_Core));
			this._Label = label;
