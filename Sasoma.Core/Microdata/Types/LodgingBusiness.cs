...
namespace Sasoma.Microdata.Types
{
	...
	/// </summary>
	public class LodgingBusiness_Core : TypeCore, ILocalBusiness
	{
		public LodgingBusiness_Core()
		{
			this._TypeId = 157;
			this._Id = "LodgingBusiness";
			this._Schema_Org_Url = "http://schema.org/LodgingBusiness";
			string label = "";
			GetLabel(out label, "LodgingBusiness", typeof(LodgingBusiness_Core));
			this._Label = label;
			this._Ancestors = new int[]{266,193,155};
			this._SubTypes = new int[]{36,131,132,154};
