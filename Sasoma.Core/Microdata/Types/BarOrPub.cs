...
namespace Sasoma.Microdata.Types
{
	...
	/// A bar or pub.
	/// </summary>
	public class BarOrPub_Core : TypeCore, IFoodEstablishment
	{
		public BarOrPub_Core()
		{
			this._TypeId = 33;
			this._Id = "BarOrPub";
			this._Schema_Org_Url = "http://schema.org/BarOrPub";
			string label = "";
			GetLabel(out label, "BarOrPub", typeof(BarOrPub_Core));
			this._Label = label;
