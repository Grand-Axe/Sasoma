...
namespace Sasoma.Microdata.Types
{
	...
	/// A TV season.
	/// </summary>
	public class TVSeason_Core : TypeCore, ICreativeWork
	{
		public TVSeason_Core()
		{
			this._TypeId = 257;
			this._Id = "TVSeason";
			this._Schema_Org_Url = "http://schema.org/TVSeason";
			string label = "";
			GetLabel(out label, "TVSeason", typeof(TVSeason_Core));
			this._Label = label;
			this._Ancestors = new int[]{266,78};
			this._SubTypes = new int[0];
			this._SuperTypes = new int[]{78};
			this._Properties = new int[]{67,108,143,229,0,2,10,12,18,20,24,26,21,50,51,54,57,58,59,61,62,64,70,72,81,97,100,110,115,116,126,138,151,178,179,180,199,211,219,230,231,82,84,146,155,202,214,224};
		...
		/// The season number.
		/// </summary>
		private SeasonNumber_Core seasonNumber;
		public SeasonNumber_Core SeasonNumber
		{
			get
			{
				return seasonNumber;
			...
			{
				seasonNumber = value;
				SetPropertyInstance(seasonNumber);
			}
		}
