...
namespace Sasoma.Microdata.Types
{
	...
	/// </summary>
	public class TheaterGroup_Core : TypeCore, IPerformingGroup
	{
		public int TypeId
		{
			get
		...
		public string Schema_Org_Url
		{
			get
			{
				return "http://schema.org/TheaterGroup";
			}
		}
		...
		public string Label
		{
			get
			{
				GetLabel(out label, "TheaterGroup", typeof(TheaterGroup_Core));
				return label;
			}
		}
		...
		public int[] Properties
		{
			get
			{
				return new int[]{67,108,143,229,5,10,47,75,77,85,91,94,95,115,130,137,199,196};
			}
		}
