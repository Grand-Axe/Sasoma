...
namespace Sasoma.Microdata.Types
{
	...
	/// A grocery store.
	/// </summary>
	public class GroceryStore_Core : TypeCore, IStore
	{
		public GroceryStore_Core()
		{
			this._TypeId = 119;
			this._Id = "GroceryStore";
			this._Schema_Org_Url = "http://schema.org/GroceryStore";
			string label = "";
			GetLabel(out label, "GroceryStore", typeof(GroceryStore_Core));
			this._Label = label;
