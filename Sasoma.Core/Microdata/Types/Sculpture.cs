...
namespace Sasoma.Microdata.Types
{
	...
	/// </summary>
	public class Sculpture_Core : TypeCore, ICreativeWork
	{
		public Sculpture_Core()
		{
			this._TypeId = 235;
			this._Id = "Sculpture";
			this._Schema_Org_Url = "http://schema.org/Sculpture";
			string label = "";
			GetLabel(out label, "Sculpture", typeof(Sculpture_Core));
			this._Label = label;
