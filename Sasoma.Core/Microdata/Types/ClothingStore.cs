...
namespace Sasoma.Microdata.Types
{
	...
	/// A clothing store.
	/// </summary>
	public class ClothingStore_Core : TypeCore, IStore
	{
		public ClothingStore_Core()
		{
			this._TypeId = 63;
			this._Id = "ClothingStore";
			this._Schema_Org_Url = "http://schema.org/ClothingStore";
			string label = "";
			GetLabel(out label, "ClothingStore", typeof(ClothingStore_Core));
			this._Label = label;
