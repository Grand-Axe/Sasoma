...
namespace Sasoma.Microdata.Types
{
	...
	/// A hardware store.
	/// </summary>
	public class HardwareStore_Core : TypeCore, IStore
	{
		public HardwareStore_Core()
		{
			this._TypeId = 122;
			this._Id = "HardwareStore";
			this._Schema_Org_Url = "http://schema.org/HardwareStore";
			string label = "";
			GetLabel(out label, "HardwareStore", typeof(HardwareStore_Core));
			this._Label = label;
