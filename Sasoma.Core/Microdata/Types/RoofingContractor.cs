...
namespace Sasoma.Microdata.Types
{
	...
	/// </summary>
	public class RoofingContractor_Core : TypeCore, IHomeAndConstructionBusiness
	{
		public RoofingContractor_Core()
		{
			this._TypeId = 231;
			this._Id = "RoofingContractor";
			this._Schema_Org_Url = "http://schema.org/RoofingContractor";
			string label = "";
			GetLabel(out label, "RoofingContractor", typeof(RoofingContractor_Core));
			this._Label = label;
			this._Ancestors = new int[]{266,193,155,128};
			this._SubTypes = new int[0];
			this._SuperTypes = new int[]{128,216};
