...
namespace Sasoma.Microdata.Types
{
	...
	/// A bowling alley.
	/// </summary>
	public class BowlingAlley_Core : TypeCore, ISportsActivityLocation
	{
		public BowlingAlley_Core()
		{
			this._TypeId = 44;
			this._Id = "BowlingAlley";
			this._Schema_Org_Url = "http://schema.org/BowlingAlley";
			string label = "";
			GetLabel(out label, "BowlingAlley", typeof(BowlingAlley_Core));
			this._Label = label;
