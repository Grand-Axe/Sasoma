...
namespace Sasoma.Microdata.Types
{
	...
	/// </summary>
	public class ElementarySchool_Core : TypeCore, IEducationalOrganization
	{
		public ElementarySchool_Core()
		{
			this._TypeId = 91;
			this._Id = "ElementarySchool";
			this._Schema_Org_Url = "http://schema.org/ElementarySchool";
			string label = "";
			GetLabel(out label, "ElementarySchool", typeof(ElementarySchool_Core));
			this._Label = label;
