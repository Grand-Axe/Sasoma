...
namespace Sasoma.Microdata.Types
{
	...
	/// A middle school.
	/// </summary>
	public class MiddleSchool_Core : TypeCore, IEducationalOrganization
	{
		public MiddleSchool_Core()
		{
			this._TypeId = 165;
			this._Id = "MiddleSchool";
			this._Schema_Org_Url = "http://schema.org/MiddleSchool";
			string label = "";
			GetLabel(out label, "MiddleSchool", typeof(MiddleSchool_Core));
			this._Label = label;
