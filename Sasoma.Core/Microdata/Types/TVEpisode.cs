...
namespace Sasoma.Microdata.Types
{
	...
	public class TVEpisode_Core : TypeCore, ICreativeWork
	{
		...
		/// </summary>
		public Actors_Core Actors { get; set; }
		...
		/// </summary>
		public Director_Core Director { get; set; }
		...
		/// The episode number.
		/// </summary>
		public EpisodeNumber_Core EpisodeNumber { get; set; }
		...
		/// </summary>
		public MusicBy_Core MusicBy { get; set; }
		...
		/// </summary>
		public PartOfSeason_Core PartOfSeason { get; set; }

		/// <summary>
		/// The TV series to which this episode or season belongs.
		/// </summary>
		public PartOfTVSeries_Core PartOfTVSeries { get; set; }

		/// <summary>
		/// The producer of the movie, TV series, season, or episode, or video.
		/// </summary>
		public Producer_Core Producer { get; set; }
		...
		/// </summary>
		public Trailer_Core Trailer { get; set; }
