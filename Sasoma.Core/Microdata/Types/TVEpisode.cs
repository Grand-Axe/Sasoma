...
namespace Sasoma.Microdata.Types
{
	...
	/// </summary>
	public class TVEpisode_Core : TypeCore, ICreativeWork
	{
		public TVEpisode_Core()
		{
			this._TypeId = 256;
			this._Id = "TVEpisode";
			this._Schema_Org_Url = "http://schema.org/TVEpisode";
			string label = "";
			GetLabel(out label, "TVEpisode", typeof(TVEpisode_Core));
			this._Label = label;
			this._Ancestors = new int[]{266,78};
			this._SubTypes = new int[0];
			this._SuperTypes = new int[]{78};
			this._Properties = new int[]{67,108,143,229,0,2,10,12,18,20,24,26,21,50,51,54,57,58,59,61,62,64,70,72,81,97,100,110,115,116,126,138,151,178,179,180,199,211,219,230,231,3,68,83,141,154,155,174,176,224};
		...
		/// </summary>
		private Actors_Core actors;
		public Actors_Core Actors
		{
			get
			{
				return actors;
		...
		/// </summary>
		private Director_Core director;
		public Director_Core Director
		{
			get
			{
				return director;
		...
		/// The episode number.
		/// </summary>
		private EpisodeNumber_Core episodeNumber;
		public EpisodeNumber_Core EpisodeNumber
		{
			get
			{
			...
			{
				episodeNumber = value;
				SetPropertyInstance(episodeNumber);
			}
		}
		...
		/// </summary>
		private MusicBy_Core musicBy;
		public MusicBy_Core MusicBy
		{
			get
			{
				return musicBy;
		...
		/// </summary>
		private PartOfSeason_Core partOfSeason;
		public PartOfSeason_Core PartOfSeason
		{
			get
			{
				return partOfSeason;
			...
			{
				partOfSeason = value;
				SetPropertyInstance(partOfSeason);
			}
		}
		...
		/// </summary>
		private PartOfTVSeries_Core partOfTVSeries;
		public PartOfTVSeries_Core PartOfTVSeries
		{
			get
			{
			...
			set
			{
				partOfTVSeries = value;
				SetPropertyInstance(partOfTVSeries);
			}
		}
		...
		/// </summary>
		private Producer_Core producer;
		...
		/// </summary>
		private ProductionCompany_Core productionCompany;
		public ProductionCompany_Core ProductionCompany
		{
			get
			{
			...
			set
			{
				...
				SetPropertyInstance(productionCompany);
			}
		}
		...
		/// </summary>
		private Trailer_Core trailer;
		public Trailer_Core Trailer
		{
			get
			{
				return trailer;
