...
namespace Sasoma.Microdata.Types
{
	...
	/// </summary>
	public class FinancialService_Core : TypeCore, ILocalBusiness
	{
		public FinancialService_Core()
		{
			this._TypeId = 103;
			this._Id = "FinancialService";
			this._Schema_Org_Url = "http://schema.org/FinancialService";
			string label = "";
			GetLabel(out label, "FinancialService", typeof(FinancialService_Core));
			this._Label = label;
			this._Ancestors = new int[]{266,193,155};
			this._SubTypes = new int[]{9,29,32,137};
