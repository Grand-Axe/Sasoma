...
namespace Sasoma.Microdata.Types
{
	...
	/// User interaction: +1.
	/// </summary>
	public class UserPlusOnes_Core : TypeCore, IUserInteraction
	{
		public UserPlusOnes_Core()
		{
			this._TypeId = 281;
			this._Id = "UserPlusOnes";
			this._Schema_Org_Url = "http://schema.org/UserPlusOnes";
			string label = "";
			GetLabel(out label, "UserPlusOnes", typeof(UserPlusOnes_Core));
			this._Label = label;
