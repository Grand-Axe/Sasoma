...
namespace Sasoma.Microdata.Types
{
	...
	/// An auto parts store.
	/// </summary>
	public class AutoPartsStore_Core : TypeCore, IStore
	{
		public AutoPartsStore_Core()
		{
			this._TypeId = 25;
			this._Id = "AutoPartsStore";
			this._Schema_Org_Url = "http://schema.org/AutoPartsStore";
			string label = "";
			GetLabel(out label, "AutoPartsStore", typeof(AutoPartsStore_Core));
			this._Label = label;
			this._Ancestors = new int[]{266,193,155,252};
			this._SubTypes = new int[0];
			this._SuperTypes = new int[]{30,252};
